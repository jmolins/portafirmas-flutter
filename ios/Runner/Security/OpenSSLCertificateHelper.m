...
+ (PFCertificateInfo *)getPFCertificateInfoFromCertificate:(SecCertificateRef)certificateRef
{
    if (certificateRef != NULL) {
        ...
        [certificateInfo setSerial:[self getSerialNumberForCertificate:certificateX509]];
...
+ (NSString *)getSerialNumberForCertificate:(X509 *)certificateX509
{
    ...
    if (certificateX509 != NULL) {
        ...
        serialNumber = [NSString stringWithCString:(const char *) asciiHex
